...
There is an online wallet which can be used to sign the messages as well. You can find it [here](https://reinproject.org/bitcoin-signature-tool/#sign).  
 In order to sign, be careful to use only the second line of the signed message!
